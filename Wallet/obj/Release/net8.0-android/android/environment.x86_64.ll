...
@dso_cache = dso_local local_unnamed_addr global [532 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 892332785243404221, ; hash 0xc6233f0bdde37bd, from name: libaot-Wallet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 26
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 12721615014754257788, ; hash 0xb08c417433b40b7c, from name: aot-Wallet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 367
	...
	%struct.DSOCacheEntry {
		i64 14382076522794061316, ; hash 0xc7976665e1a00e04, from name: libaot-Wallet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 421
	...
	%struct.DSOCacheEntry {
		i64 14582473433193355632, ; hash 0xca5f5a53840f9970, from name: aot-Wallet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 424
	...
	%struct.DSOCacheEntry {
		i64 16022812880888346435, ; hash 0xde5c776c33e73743, from name: Wallet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 462
	...
	%struct.DSOCacheEntry {
		i64 16485852232405450151, ; hash 0xe4c98342741b7da7, from name: Wallet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 478
...
@.env.3 = private unnamed_addr constant [37 x i8] c"7005a8fd-9599-44b5-a34d-7535e5fb6e89\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [32 x i8] c"com.TransactiSave.TransactiSave\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [21 x i8] c"libaot-Wallet.dll.so\00", align 16
