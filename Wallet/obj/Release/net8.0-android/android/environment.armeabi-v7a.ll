...
@dso_cache = dso_local local_unnamed_addr global [532 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 103366368, ; hash 0x6293ee0, from name: Wallet.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1591355548, ; hash 0x5eda289c, from name: aot-Wallet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 179
	...
	%struct.DSOCacheEntry {
		i64 1845572920, ; hash 0x6e013538, from name: libaot-Wallet.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 211
	...
	%struct.DSOCacheEntry {
		i64 2166848349, ; hash 0x81277b5d, from name: libaot-Wallet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 258
	...
	%struct.DSOCacheEntry {
		i64 3077473764, ; hash 0xb76e85e4, from name: Wallet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 388
	...
	%struct.DSOCacheEntry {
		i64 3666048097, ; hash 0xda837461, from name: aot-Wallet
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-Wallet.dll.so
		ptr null; void* handle (0x0)
	}, ; 457
